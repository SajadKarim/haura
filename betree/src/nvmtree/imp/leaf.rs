...
pub(super) struct LeafNode {
    storage_preference: AtomicStoragePreference, // SajadKarim: This would not be required for NVMTree!
    /// A storage preference assigned by the Migration Policy
    system_storage_preference: AtomicSystemStoragePreference, // SajadKarim: This would not be required for NVMTree!
    entries_size: usize,
